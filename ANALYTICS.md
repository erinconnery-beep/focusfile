...
- `select_calendar_reminder_weekdays`, `select_calendar_reminder_daily`, `select_calendar_reminder_custom`
- `open_google_calendar_reminder_weekdays`, `open_google_calendar_reminder_daily`, `open_google_calendar_reminder_custom`
- `download_other_calendar_reminder_weekdays`, `download_other_calendar_reminder_daily`, `download_other_calendar_reminder_custom`
